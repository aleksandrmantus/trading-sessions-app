...
const ControlDeck: React.FC<ControlDeckProps> = ({ menuContainerRef, isMenuOpen, onMenuToggle, onCloseMenu, ...props }) => {
  return (
    <div className={`relative ${isMenuOpen ? 'z-50' : ''} bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 p-2 rounded-xl shadow-lg shadow-black/5 dark:shadow-black/20`}>
